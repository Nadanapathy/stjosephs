    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <li ><a href="failure_list.jsp"> Failures List </a></li>
           ...
           <li class="active"><a href="cum_single_failures.jsp"> Cum.Single Fail List </a></li>
	    ...
	    ResultSet rt1=ps1.executeQuery();
            ...
            String addquery="";int querycount=1;
              ...
              //    subjects.add(scode);
               ...
               rt=ps.executeQuery();
           %>
           <form action="print_cum_single.jsp" method="post">
...
//                               int c=0;
           ...
           <% 
                                                    ...
                                                    System.out.println("Cum Single Failures :"+e);
                                                    %>
                                                    <center>
