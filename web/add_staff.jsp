...
if(request.getParameter("has")!=null){
    out.println("<script>alert('Staff Id Already Exist !')</script>");
}
%>
...
<div class="container">
    <div class="col-sm-4">
        <form action="UploadStaff" method="post" enctype="multipart/form-data">
				...
				<div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input type="file"  name="file" required="required" class="form-control" placeholder="Enter Staff ID" />
					</div>
	...
	<div class="col-sm-4" >
            <form action="AddStaff" method="post">
				...
				<div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <input type="text"  name="staffid" required="required" class="form-control" placeholder="Enter Staff ID" />
					</div>
					<div class="form-group">
                                            <input type="text"  name="staffname" required="required" class="form-control" placeholder="Enter Staff Name" />
					</div>
                                                <center>
