...
//               ps1.close();
              ...
              // String qs=request.getQueryString();
               ...
               query="SELECT reg_no,section_,name_,(select mark_ from "+dept+"_"+"sem"+sem+" where type_='"+type+"' and subject_code='"+subjectcode+"' and reg_no=sd.reg_no ) FROM `student_details` sd where department_='"+dept+"' and current_sem='"+sem+"'  and shift='"+shift+"' and section_ ='"+section+"'  ORDER BY reg_no ASC ";
           ...
           <div class="col-md-12" style="text-align: center;">
                    ...
                    <tr>
                       ...
                       <%
                            ...
                            String t=GetSubjects.getSubjecName(subjectcode);
                            %>
                   ...
                   int count=1;
                    ...
                    <tr>
                       ...
                       <%
                           ...
                           String v=rt.getString("(select mark_ from "+dept+"_"+"sem"+sem+" where type_='"+type+"' and subject_code='"+subjectcode+"' and reg_no=sd.reg_no )");
