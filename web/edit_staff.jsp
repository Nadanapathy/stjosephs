  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="edit_staff.jsp"> Edit Staff</a></li>
...
<!--		<li><a href="#"> Allocate </a></li>
     ...
     <div class="container" style="min-height: 498px;">
            ...
            <h1 style="text-align: center;">Edit Staff Details</h1>
...
<h2>All Staffs</h2>
 <%
  ...
  <div class="form-group col-md-4">
      <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search for Dept Name or Staff id.." title="Type in a name">
  </div>
