...
<div class="col-md-12">
		<%
            ...
            String query="SELECT * FROM `announce` ";
		...
		%>
                <table class="table table-hover" id="myTable">
                    <caption>
                        <center>
                            <h1>Announce Status</h1>
                        </center>
                    </caption>
                    <tr style="background-color: #cccccc">
                        <th>Type</th>
                        <th style="text-align: center;">Student Mark View Status</th>
                        <th style="text-align: center;">Staff Mark Entry Status</th>
                    </tr>
                    <%
                    while(rt.next()){
                        String change="yes";
                        if(rt.getString("status_").equalsIgnoreCase("yes")){
                            change="no";
                        }
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <%=rt.getString("status_")%> &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="ChangeAnnounce?id=<%=rt.getString("id")%>&change=<%=change%>">Change </a>
                        </td>
                         <td style="text-align: center;">
                             <%=rt.getString("mark_entry_status")%>&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="ChangeMarkEntry?id=<%=rt.getString("id")%>&change=<%=mchange%>">Change </a>
                         </td>
