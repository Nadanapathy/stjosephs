...
<!--		<li><a href="#"> Allocate </a></li>
     ...
     <div class="container" style="min-height: 498px;">
            ...
            <h1 style="text-align: center;">Allocate Subject and Class to Staff</h1>
   

 <%
     String dept=session.getAttribute("Department").toString();
   Connection con=db.Dbconnection.getCon();
            String query="select * from staff_details where department_='"+dept+"' order by name_ asc";
            PreparedStatement ps=con.prepareStatement(query);
	   
	    ResultSet rt=ps.executeQuery();
  %>
<h2>All Staffs in <%=dept.toUpperCase()%> Department</h2>
  <div class="form-group col-md-4">
      <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="Search for staff Name or Staff Id.." title="Type in a name">
  </div>
...
<table class="table table-hover" id="myTable">
  ...
  <tr>
    ...
    <td>
        ...
        <a href="hod_allocate_sub.jsp?id=<%=id%>">Allocate</a>
    </td>
  </tr>
  </tbody>
