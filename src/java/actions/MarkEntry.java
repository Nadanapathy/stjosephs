    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      response.setContentType("text/html;charset=UTF-8");
        try (PrintWriter out = response.getWriter()) {
           ...
           String subcode=request.getParameter("subjectcode").toLowerCase();
           String handling_id=request.getParameter("handling");
	    ...
	    PreparedStatement ps1=con.prepareStatement(query1);
           ...
           boolean status= Beans.MarkStatus.makeUpdated(handling_id, type);
            if(status){
               out.println("Status : Mark Updated Successfully"); 
            }else{
                out.println("Status : Mark Updation Failed !"); 
            }
             out.println("<center><h1>Mark Entered Successfully !</h1><br><a href='staff_home.jsp'>Click to Back</a></center>");
