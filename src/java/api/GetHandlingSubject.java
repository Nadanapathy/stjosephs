 ...
 * @author unbox
 */
public class GetHandlingSubject extends HttpServlet {
	   ...
	   JSONObject result=new JSONObject();
        ...
        try{
          ...
          //  String staffid=request.getQueryString();
           ...
           Connection con=db.Dbconnection.getCon();
            ...
            String query="SELECT `id`, `staff_details_id`, `staff_id`, `subject_id`, `subject_code`, `subject_name`, `department_`, `semester_`, `section_`, `shift_`, `is_incharge`,(select name_ from staff_details where staff_id=hs.staff_id) from handling_subjects hs where department_='"+dept1+"' and semester_='"+semester+"' and section_='"+section+"' and shift_='"+shift+"'";
            
            System.out.println("Get Handling Subjects :"+query);
	    ...
	    ResultSet rt=ps.executeQuery();
            ...
            while(rt.next()){
                ...
                data.put("StaffId", rt.getString("staff_id"));
                data.put("StaffName", rt.getString("(select name_ from staff_details where staff_id=hs.staff_id)"));
                data.put("Isincharge", rt.getString("is_incharge"));
